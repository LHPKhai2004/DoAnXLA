...
# ✅ Tự động xác định đường dẫn tới model .onnx
...
if __name__ == '__main__':
    ...
    recognizer = cv.FaceRecognizerSF.create(fr_path, "")
    ...
    while True:
        ...
        if key == ord('s') or key == ord('S'):
            if faces[1] is not None:
                ...
                file_name = os.path.abspath(os.path.join(script_dir, '..', 'image', 'Thinh', 'thinh_%04d.bmp' % dem))
